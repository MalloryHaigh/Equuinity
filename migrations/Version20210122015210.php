 ...
 */
final class Version20210122015210 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bank_transactions ADD CONSTRAINT FK_2A30FD572130303A FOREIGN KEY (from_user_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE bank_transactions ADD CONSTRAINT FK_2A30FD5729F6EE60 FOREIGN KEY (to_user_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
